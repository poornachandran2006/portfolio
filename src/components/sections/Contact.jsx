    ...
    <section id="contact" className="py-24 lg:py-32 bg-white dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.p
            variants={fadeUp}
            className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-12 text-center max-w-2xl mx-auto"
          >
            {contact.subtext}
          </motion.p>
          ...
          >
            ...
            <motion.a
              ...
              className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-2 border-blue-200 dark:border-blue-700 rounded-2xl p-8 hover:shadow-2xl hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 relative overflow-hidden"
            >
              <motion.div
              ...
              />
              <motion.div 
                className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform relative z-10 shadow-lg"
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              transition={{ duration: 0.3 }}
              className="group bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-2 border-purple-200 dark:border-purple-700 rounded-2xl p-8 hover:shadow-2xl hover:border-purple-500 dark:hover:border-purple-500 transition-all duration-300 relative overflow-hidden"
            >
              <motion.div
              ...
              />
              <motion.div 
                className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform relative z-10 shadow-lg"
                whileHover={{ rotate: 360 }}
                transition={{ duration: 0.6 }}
              >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              transition={{ duration: 0.3 }}
              className="group bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-2 border-green-200 dark:border-green-700 rounded-2xl p-8 hover:shadow-2xl hover:border-green-500 dark:hover:border-green-500 transition-all duration-300 relative overflow-hidden"
            >
              <motion.div
              ...
              />
              <motion.div 
                className="w-14 h-14 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform relative z-10 shadow-lg"
                whileHover={{ rotate: 360 }}
                transition={{ duration: 0.6 }}
              >
          ...
          <motion.div
            variants={fadeUp}
            className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-8"
          >
